...
object OnlineTrainAndPredict {
    ...
    val lrtraindatapath = PathNamespace.prefix + "onlinelrfeature"

    //val lrtestdatapath = PathNamespace.prefix + "luolr/testdata"
    //val lrtestdatapath = PathNamespace.prefix + "cleanthalrtest"
    val lrtestdatapath = PathNamespace.prefix + "onlinelrtest"

    //val prefix: String = PathNamespace.prefix + "lrluojiayoujiayou3/"
    //val yaprefix: String = PathNamespace.prefix + "lrluoyajiayoujiayou3/"
    val prefix: String = PathNamespace.prefix + "lrluojiayoujiayou3cleantha/"
    val yaprefix: String = PathNamespace.prefix + "lrluoyajiayoujiayou3cleantha/"
    ...
    def joinPredictResultWithItemData(sc: org.apache.spark.SparkContext, predictResult: org.apache.spark.rdd.RDD[(String, (String, Double))], limit: Int): org.apache.spark.rdd.RDD[String] = {
        ...
        val a = PathNamespace.onlinetrainfeaturesubdata
        ...
        newresult.coalesce(1).saveAsTextFile(PathNamespace.prefix + "prediction0416")
    ...
    def trainAndPredict(sc: org.apache.spark.SparkContext): Unit = {
        ...
        for (i <- 15 to 15 by 5) {
            ...
            val predictresult = offlineLRTest(sc, finaltraindatapath, lrtestdatapath, Cota.SUBMIT_COUNT)

            //predictresult.coalesce(1).saveAsTextFile(yaprefix + "offlinepredictresult-" + i)
