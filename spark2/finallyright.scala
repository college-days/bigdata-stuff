val a = sc.textFile(PathNamespace.prefix + "subset/offlinetrainfeatures")

val featureinputpath = PathNamespace.prefix + "subset/offlinetrainfeatures"
val traindatainputpath = PathNamespace.offlinetrainlabeldata
...
b.coalesce(1).saveAsTextFile(PathNamespace.prefix + "cleanthalrfeature")

#test
val useritemFeaturePath = PathNamespace.prefix + "subset/offlinetestfeatures"
...
b.coalesce(1).saveAsTextFile(PathNamespace.prefix + "cleanthalrtest")
