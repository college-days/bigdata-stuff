...
public class HBaseUtil {
    ...
    public static Configuration getConfiguration(){
        ...
        conf.set("hbase.zookeeper.quorum", "work01,work02,work03");
        return conf;
    }
     ...
     */
    public static HBaseAdmin getHBaseAdmin() throws MasterNotRunningException, ZooKeeperConnectionException, IOException{
